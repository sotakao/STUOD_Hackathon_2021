...
We would like to thank Ronan Fablet (IMT Atlantique) and Jean-Francois Piolle (IFRMER) for agreeing to help out with the hackathon. We thank especially Jean-Francois and Nicolas Reulle (IFREMER) for providing us with the Tropical cyclone and El Nino datasets.
